...
const handleAmount = (e) => (type === 'burn') ? setAmount(-Math.abs(e.target.value)) : setAmount(e.target.value)
    ...
    <>
      ...
      Add Exercise activity
        ...
        <div className="form-control">
          ...
          <input type="text" value={text} onChange={(e) => setText(e.target.value)} placeholder="Enter Calorie Event(Food in/Exercise Out)" />
        </div>
        <div className="form-control">
